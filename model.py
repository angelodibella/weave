...
class StabilizerModel:
    def __init__(
        ...
        logical_index: int = 0,  # TODO: Make this take a list instead as well. Also, make method to extract logicals of code!
        **kwargs,
    ) -> None:
        ...
        match main_code:
            ...
            case "hypergraph_product_code":
                ...
                self.clist1: list = self.code_params["clist1"]
                self.clist2: list = self.code_params["clist2"]
    ...
    def construct_graph(self, HX: np.ndarray, HZ: np.ndarray) -> nx.Graph:
    ...
    def node_to_qubit(self, node: str) -> int:
        # TODO: Maybe move this to util.py.
        def strip(s: str) -> int:
            s_int = ""
            for c in s:
                if c.isdigit():
    ...
    def _hypergraph_product_code(self, experiment: str | None) -> None:
        ...
        self.graph = self.construct_graph(HX, HZ)
